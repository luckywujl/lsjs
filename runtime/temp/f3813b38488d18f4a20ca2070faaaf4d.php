<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/sale/detailtemp/edit.html";i:1629966961;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-3">
            <?php echo build_radios('row[detail_isrecord]', [0=>__('Detail_isrecord 0'), 1=>__('Detail_isrecord 1')], $row['detail_isrecord']); ?>
        </div>
        
        <div class="col-xs-12 col-sm-1" hidden="hidden">
            <input id="c-detail_product_info_id" class="form-control" name="row[detail_product_info_id]" type="text" value="<?php echo htmlentities($row['detail_product_info_id']); ?>">
        </div>
        
        <div class="col-xs-12 col-sm-1" hidden="hidden">
            <input id="c-detail_user_id" class="form-control" name="row[detail_user_id]" type="text" value="<?php echo htmlentities($row['detail_user_id']); ?>">
        </div>
    </div>
    <div class="form-group" id="install" style="visibility: <?php echo $row['detail_isrecord']?'hidden':'visible'; ?>;">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Detail_isinstall'); ?>:</label>
        <div class="col-xs-12 col-sm-3">
            <?php echo build_radios('row[detail_isinstall]', [0=>__('Detail_isinstall 0'), 1=>__('Detail_isinstall 1')], $row['detail_isinstall']); ?>
        </div>
        
        
    </div>
    <div class="form-group" id="user_info" style="visibility: <?php echo $row['detail_isinstall']?'visible':'hidden'; ?>;">
  	 	  <label class="control-label col-xs-12 col-sm-2"><?php echo __('Detail_user_name'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_user_name" class="form-control" name="row[detail_user_name]" type="text" value="<?php echo htmlentities($row['detail_user_name']); ?>">
        </div>
    	  <label class="control-label col-xs-12 col-sm-1"><?php echo __('Detail_user_tel'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_user_tel" class="form-control" name="row[detail_user_tel]" type="text" value="<?php echo htmlentities($row['detail_user_tel']); ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Detail_user_address'); ?>:</label>
        
        <div class="col-xs-12 col-sm-2">
            <input id="c-detail_user_address" class="form-control" name="row[detail_user_address]" type="text" value="<?php echo htmlentities($row['detail_user_address']); ?>">
        </div>
