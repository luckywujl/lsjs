<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/sale/order/add.html";i:1630145528;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_user_tel"  class="form-control" name="row[order_user_tel]" type="text">
        </div>
   
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_user_address'); ?>:</label>
        <div class="col-xs-12 col-sm-3">
            <input id="c-order_user_address"  class="form-control" name="row[order_user_address]" type="text">
        </div>
        <button type="button" class="btn btn-success btn-adduser"><?php echo __('查找'); ?></button>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Order_user_contact'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_user_contact" data-rule="required" class="form-control" name="row[order_user_contact]" type="text">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_saleman" data-rule="required" class="form-control selectpage" data-source="auth/admin/index" data-field="nickname" data-primary-key="nickname" name="row[order_saleman]" type="text">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_sale_type'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_sale_type"  class="form-control"  name="row[order_sale_type]" type="text">
        </div>
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_user_area'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_user_area"  class="form-control selectpage" data-source="base/area/index" data-field="area" data-primary-key="area"  name="row[order_user_area]" type="text">
        </div>
