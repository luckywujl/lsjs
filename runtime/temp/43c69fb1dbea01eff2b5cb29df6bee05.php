<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:98:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/sale/callback/logedit.html";i:1630150526;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<form id="logedit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Productinfo.product_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_name" class="form-control" readonly="readonly" data-rule="required"  name="row[product_name]" type="text" value="<?php echo $row['productinfo']['product_name']; ?>">
        </div>
    </div>
    
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Productinfo.product_type'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_type" class="form-control" readonly="readonly" data-rule="required"  name="row[product_type]" type="text" value="<?php echo $row['productinfo']['product_type']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-log_water_gage" class="form-control" readonly="readonly" name="row[log_water_gage]" type="text" value="<?php echo htmlentities($row['log_water_gage']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Log_user_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-log_user_name" class="form-control" readonly="readonly" name="row[log_user_name]" type="text" value="<?php echo htmlentities($row['log_user_name']); ?>">
        </div>
    </div>
     <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Log_user_contact'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-log_user_contact" class="form-control" readonly="readonly" name="row[log_user_contact]" type="text" value="<?php echo htmlentities($row['log_user_contact']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Log_address'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-log_address" class="form-control" readonly="readonly" name="row[log_address]" type="text" value="<?php echo htmlentities($row['log_address']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_code" class="form-control" readonly="readonly" name="product[product_code]" data-rule="required" type="text" value="<?php echo htmlentities($product['product_code']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Product_install_place'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_install_place" class="form-control selectpage" readonly="readonly" data-rule="required" data-source="base/installplace/index" data-field="install_place" data-primary-key="install_place" name="product[product_install_place]" type="text" value="<?php echo htmlentities($product['product_install_place']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Product_install_type'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_install_type" class="form-control selectpage" readonly="readonly" data-rule="required" data-source="base/installtype/index" data-field="install_type" data-primary-key="install_type" name="product[product_install_type]" type="text" value="<?php echo htmlentities($product['product_install_type']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Product_purpose'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_purpose" class="form-control selectpage" readonly="readonly" data-rule="required" data-source="base/purpose/index" data-field="purpose" data-primary-key="purpose" name="product[product_purpose]" type="text" value="<?php echo htmlentities($product['product_purpose']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-product_replacement_date" readonly="readonly" class="form-control datetimepicker"  data-rule="required" data-date-format="YYYY-MM-DD" data-use-current="true" name="product[product_replacement_date]" type="text" value="<?php echo $product['product_replacement_date']?datetime($product['product_replacement_date']):''; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
        		<?php echo build_radios('row[log_valuation_star]', [5=>__('非常满意'), 4=>__('满意'), 3=>__('一般'), 2=>__('不满意'), 1=>__('很不满意')], $row['log_valuation_star']); ?>
        </div>
    </div>
  <div class="form-group layer-footer">
        <label class="control-label col-xs-12 col-sm-2"></label>
        <div class="col-xs-12 col-sm-8">
            <button type="submit" class="btn btn-success btn-embossed disabled"><?php echo __('单个回访'); ?></button>
