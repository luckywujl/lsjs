<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/service/rorder/add.html";i:1630150036;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group" hidden="hidden">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_engineer"  class="form-control "  name="row[order_engineer]" type="text" value="<?php echo htmlentities($user_info['engineer']); ?>">
        </div>
       
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_service_datetime'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_service_datetime" class="form-control "  name="row[order_service_datetime]" type="text" value="<?php echo htmlentities($user_info['service_datetime']); ?>">
        </div> 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_user_contact" data-rule="required" readonly="readonly" class="form-control" name="row[order_user_contact]" type="text" value="<?php echo htmlentities($user_info['user_contact']); ?>">
