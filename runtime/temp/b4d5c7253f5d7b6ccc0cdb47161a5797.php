<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/user/user/edit.html";i:1630142690;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('First'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-first" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[first]" type="text" value="<?php echo $row['first']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Last'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-last" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[last]" type="text" value="<?php echo $row['last']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-area" class="form-control selectpage" data-source="base\area\index" data-field="area" data-primary-key="area" name="row[area]" type="text" value="<?php echo htmlentities($row['area']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Type'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-type" class="form-control selectpage" data-source="base/customtype/index" data-field="custom_type" data-primary-key="custom_type" name="row[type]" type="text" value="<?php echo htmlentities($row['type']); ?>">
        </div>
    </div>
    <div class="form-group">
