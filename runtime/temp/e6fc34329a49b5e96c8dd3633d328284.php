<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:112:"/media/luckywujl/data/www/admin/localhost_9006/wwwroot/public/../application/admin/view/sale/detailtemp/add.html";i:1627574541;s:97:"/media/luckywujl/data/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:94:"/media/luckywujl/data/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:96:"/media/luckywujl/data/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-detail_remark" class="form-control " rows="5" name="row[detail_remark]" cols="50"></textarea>
        </div>
    </div>
     <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[detail_isrecord]-<?php echo $key; ?>"><input id="row[detail_isrecord]-<?php echo $key; ?>" name="row[detail_isrecord]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
