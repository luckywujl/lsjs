<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/home/www/admin/localhost_9006/wwwroot/public/../application/admin/view/sale/order/edit.html";i:1630146422;s:81:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/layout/default.html";i:1626771292;s:78:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/meta.html";i:1626771292;s:80:"/home/www/admin/localhost_9006/wwwroot/application/admin/view/common/script.html";i:1626771292;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_user_name'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-2">
            <input id="c-order_user_contact" data-rule="required" class="form-control"  name="row[order_user_contact]" type="text" value="<?php echo htmlentities($row['order_user_contact']); ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <label class="control-label col-xs-12 col-sm-1"><?php echo __('Order_operator'); ?>:</label>
        <div class="col-xs-12 col-sm-2">
