define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'service/repaircallback/index' + location.search,
                    add_url: 'service/repaircallback/add',
                    edit_url: 'service/repaircallback/edit',
                    del_url: 'service/repaircallback/del',
                    multi_url: 'service/repaircallback/multi',
                    import_url: 'service/repaircallback/import',
                    table: 'product_log',
                }
            });
