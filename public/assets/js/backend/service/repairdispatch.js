define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'service/repairdispatch/index' + location.search,
                    add_url: 'service/repairdispatch/add',
                    edit_url: 'service/repairdispatch/edit',
                    del_url: 'service/repairdispatch/del',
                    multi_url: 'service/repairdispatch/multi',
                    import_url: 'service/repairdispatch/import',
                    table: 'product_log',
                }
            });
