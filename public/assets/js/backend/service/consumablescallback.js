define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'service/consumablescallback/index' + location.search,
                    add_url: 'service/consumablescallback/add',
                    edit_url: 'service/consumablescallback/edit',
                    del_url: 'service/consumablescallback/del',
                    multi_url: 'service/consumablescallback/multi',
                    import_url: 'service/consumablescallback/import',
                    table: 'product_log',
                }
            });
