    ...
    var Controller = {
        index: function () {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'log_type', title: __('Log_type'), operate: 'LIKE', align:'left'},
                        ...
                        {field: 'log_water_gage', title: __('Log_water_gage'), operate: 'LIKE', align:'left'},
                        {field: 'log_remark', title: __('Log_remark'), operate: 'LIKE', align:'left',visible: false},
                        {field: 'log_address', title: __('Log_address'), operate: 'LIKE', align:'left'},
                        ...
                        {field: 'user.username', title: __('User.username'), operate: 'LIKE', align:'left'},
                        ...
                        {field: 'user.address', title: __('User.address'), operate: 'LIKE', align:'left'},
            ...
            table.on('post-body.bs.table',function () {
            	...
            	$(".btn-editone").data("title",__('Callback'));
            })
